...
int main(int argc,char *argv[])
{
	...
	printf("PROGRAM:	/usr/local/bin/k8055_write_digital\n");
	...
	printf("			Examples: /usr/local/bin/k8055_write_digital 1 1 1 1 0 0 0 0\n");
	printf("			          /usr/local/bin/k8055_write_digital /dev/comedi0 1 1 1 1 0 0 0 0\n");
	printf("\n");		
	printf("		An example bash script is at /usr/share/doc/commedi-K8055_bash_interface/examples/k8055_larson_scanner.sh\n");			
	printf("\n");		
	// for k8055_write_pwm
	printf("PROGRAM:	/usr/local/bin/k8055_write_pwm\n");
	...
	printf("			Examples: /usr/local/bin/k8055_write_pwm 10 255\n");
	printf("			          /usr/local/bin/k8055_write_pwm /dev/comedi0 10 255\n");
	printf("\n");	
	// for k8055_write_digital_pin
	printf("PROGRAM:	/usr/local/bin/k8055_write_digital_pin\n");
	...
	printf("			Examples: /usr/local/bin/k8055_write_digital_pin 7 1\n");
	printf("			          /usr/local/bin/k8055_write_digital_pin /dev/comedi0 7 1\n");
	printf("\n");
	// for k8055_write_pwm_pin
	printf("PROGRAM:	/usr/local/bin/k8055_write_pwm_pin\n");
	...
	printf("			Examples: /usr/local/bin/k8055_write_pwm_pin 2 255\n");
	printf("			          /usr/local/bin/k8055_write_pwm_pin /dev/comedi0 2 255\n");
	printf("\n");
